...
- a sliding gate closure device with pedestrian opening support (Matter 1.5.0, supported by SmartThings)
- a roof window closure device with ventilation opening support (Matter 1.5.0, supported by SmartThings)

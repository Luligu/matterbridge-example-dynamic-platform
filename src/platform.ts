      ...
      this.phaseInterval = setInterval(async () => {
        ...
        if (this.roboticVacuum) {
          ...
          if (this.phase === 0) {
            ...
            await this.roboticVacuum.setAttribute('RvcOperationalState', 'operationalError', RvcOperationalState.ErrorStateEnum.NoError, this.roboticVacuum.log);
          }
          if (this.phase === 1) {
          ...
          if (this.phase === 9) {
            ...
            await this.roboticVacuum.setAttribute('RvcOperationalState', 'operationalError', RvcOperationalState.ErrorStateEnum.DustBinMissing, this.roboticVacuum.log);
          }
        }

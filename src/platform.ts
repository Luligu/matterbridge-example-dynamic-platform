...
export class ExampleMatterbridgeDynamicPlatform extends MatterbridgeDynamicPlatform {
  ...
  constructor(matterbridge: Matterbridge, log: AnsiLogger, config: PlatformConfig) {
    ...
    if (this.verifyMatterbridgeVersion === undefined || typeof this.verifyMatterbridgeVersion !== 'function' || !this.verifyMatterbridgeVersion('3.2.0-dev-20250729-fcbf392')) {
      throw new Error(
        `This plugin requires Matterbridge version >= "3.2.0-dev-20250729-fcbf392". Please update Matterbridge from ${this.matterbridge.matterbridgeVersion} to the latest version in the frontend.`,
      );
    }

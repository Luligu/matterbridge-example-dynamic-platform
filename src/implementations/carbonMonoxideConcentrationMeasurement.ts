...
type CarbonMonoxideConcentrationMeasurementStateType = InstanceType<typeof CarbonMonoxideConcentrationMeasurementBehavior.State>;
export namespace CarbonMonoxideConcentrationMeasurementBehavior {
  export interface State extends CarbonMonoxideConcentrationMeasurementStateType {}
}
